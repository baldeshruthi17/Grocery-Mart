        ...
        <div className="space-y-6">
          ...
          <div className="bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-xl space-y-5">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                <label className="block text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-1.5">Registered Rider Email</label>
                <input
                  type="email"
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                  placeholder="e.g., arjun@jangaonmart.com"
                  ...
                  activeOrders.map((o) => (
                    ...
                    >
                      ...
                      <div className="p-4 space-y-3">
                        ...
                        <div className="bg-slate-900 text-white rounded-2xl p-3 flex justify-between items-center select-none font-sans">
                          <div>
                            <p className="text-[9px] text-slate-450 font-bold uppercase">Payment Type</p>
                            <p className="text-xs font-black text-amber-400 tracking-wide mt-0.5">CASH ON DELIVERY (COD)</p>
                          </div>
                          <div className="text-right">
                            <p className="text-[9px] text-slate-450 font-bold uppercase">To collect cash</p>
                    ...
                    {claimableOrders.map((o) => (
                      <div key={o.id} className="bg-white p-3.5 rounded-2xl border border-amber-100/80 flex justify-between items-center text-left">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-[9px] text-slate-400 font-medium font-sans">Payment: ₹{o.total} Cash (COD)</p>
                        </div>
